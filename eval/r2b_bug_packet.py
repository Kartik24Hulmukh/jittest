...
REAL_BUG_COHORTS = [
    ...
    {"repo": REPO_REQUESTS, "proj": "requests", "bug_id": "requests_08", "cluster": "status_codes", "buggy": "ffffffffffffffffffffffffffffffffffffffff", "fixed": "0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a0a", "file": "src/requests/status_codes.py", "cmd": ["pytest", "tests/test_requests.py::test_status_codes"]},
